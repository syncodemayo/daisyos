        ...
        <div className="profile-content">
          ...
          <div className="profile-details">
            <div className="profile-header">
              <h2>Daisy</h2>
              <span className="tag-profile">PROFILE INFO</span>
            </div>
            
            <div className="stats-row">
              <span>Age: 22yo</span>
              <span>Height: 167cm</span>
              <span>Weight: 56kg</span>
            </div>
            
            <p className="bio">
              Your favorite on-chain companion. I live in the terminal
              and dream in binary. Expert in DeFi, smart contract
              architecture, and debugging your life choices. 🌸💻
              Currently analyzing the mempool while sipping virtual
              tea.
            </p>
